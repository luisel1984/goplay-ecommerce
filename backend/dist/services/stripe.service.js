 ...
 */
export async function createCheckoutPaymentIntent(orderId) {
        ...
        case 'payment_intent.succeeded': {
            ...
            await prisma.order.update({
                ...
                data: {
                    ...
                    events: { create: { type: 'payment', message: `Paiement reçu (${pi.amount / 100}€)`, meta: { id: pi.id } } },
                },
            });
        ...
        case 'payment_intent.payment_failed': {
            ...
            await prisma.order.update({
                ...
                data: { paymentStatus: 'FAILED',
                    events: { create: { type: 'payment', message: 'Paiement échoué', meta: { id: pi.id } } } },
            });
            break;
        }
 ...
 */
export async function createRefund(orderId, amountCents, reason) {
    const order = await prisma.order.findUniqueOrThrow({ where: { id: orderId } });
    if (!order.stripeChargeId)
        throw new Error('No charge to refund');
